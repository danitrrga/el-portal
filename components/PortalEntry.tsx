...
const PortalEntry: React.FC<PortalEntryProps> = ({ onEnter }) => {
  ...
  useEffect(() => {
    ...
    // Stage 1: The Light/Line appears
    // Stage 2: The doors open

    const timer1 = setTimeout(() => setStage(1), 500);
    const timer2 = setTimeout(() => setStage(2), 2500); // Wait reading the text
    const timer3 = setTimeout(() => onEnter(), 5500); // Cleanup after doors open
