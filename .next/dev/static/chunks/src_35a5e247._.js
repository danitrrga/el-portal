...
const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])(validUrl, validKey);
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/components/PortalEntry.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const PortalEntry = ({ onEnter })=>{
    ...
    const handleEmailAuth = async (e)=>{
        ...
        try {
            if (isSignUp) {
                const { error: signUpError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signUp({
                    email,
                    password,
                    options: {
...
_s(PortalEntry, "Rxv8nTMtBKSDxPvXaYJOsBxaDf0=");
_c = PortalEntry;
const __TURBOPACK__default__export__ = PortalEntry;
var _c;
__turbopack_context__.k.register(_c, "PortalEntry");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
"[project]/src/lib/supabaseService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class SupabaseService {
    ...
    async getProfile() {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('*').eq('id', userId).single();
        if (error) {
    ...
    async updateProfile(updates) {
        const userId = await this.getUserId();
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').update(updates).eq('id', userId);
    ...
    async uploadAvatar(file) {
        ...
        const { error: uploadError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from('el-portal-assets').upload(filePath, file, {
            upsert: true
        });
        if (uploadError) throw uploadError;
        const { data } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from('el-portal-assets').getPublicUrl(filePath);
    ...
    async getDashboardData() {
        ...
        if (profile.current_version_id) {
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('versions').select('*').eq('id', profile.current_version_id).single();
            currentVersion = data;
        }
        if (profile.current_cycle_id) {
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('cycles').select('*').eq('id', profile.current_cycle_id).single();
            currentCycle = data;
        }
        ...
        let goals = [];
        if (currentCycle) {
            const { data: hData } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('habits').select('*').eq('cycle_id', currentCycle.id);
            habits = hData || [];
            const { data: gData } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('goals').select('*').eq('cycle_id', currentCycle.id);
            goals = gData || [];
        }
        ...
        if (habits.length > 0) {
            ...
            const { data: lData } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('habit_logs').select('*').in('habit_id', habitIds);
            logs = lData || [];
        }
        // 4. Calculate Stats
    ...
    async toggleHabit(habitId, isChecked) {
        ...
        if (isChecked) {
            ...
            const { data: habit } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('habits').select('linked_goal_id').eq('id', habitId).single();
            if (habit && habit.linked_goal_id) {
                // Increment goal streak
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].rpc('increment_goal_streak', {
                ...
                const { data: goal } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('goals').select('current_streak').eq('id', habit.linked_goal_id).single();
                if (goal) {
                    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('goals').update({
            ...
            // DELETE log
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('habit_logs').delete().eq('habit_id', habitId).eq('date', todayStr);
            if (error) throw error;
    ...
    // -- SLIDES (Storage + DB) --
    async getSlides() {
        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('slides').select('*').order('category');
        if (!data) return [];
        return Promise.all(data.map(async (s)=>{
            if (s.image_url && !s.image_url.startsWith('http')) {
                const { data: signed } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from('el-portal-assets').createSignedUrl(s.image_url, 3600); // 1 hour expiry
                if (signed) {
                    return {
                        ...s,
    ...
    async updateSlide(slide, imageFile) {
        ...
        if (imageFile) {
            ...
            const { error: uploadError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from('el-portal-assets').upload(filePath, imageFile, {
                upsert: true
            });
            if (uploadError) throw uploadError;
        ...
        // Update DB Record
        // Check if exists
        const { data: existing } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('slides').select('id').eq('category', slide.category).single();
        if (existing) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('slides').update({
                image_url: imageUrl,
                caption: slide.caption
            }).eq('id', existing.id);
        } else {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('slides').insert({
                user_id: userId,
    ...
    async getSlideImageUrl(path) {
        ...
        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from('el-portal-assets').createSignedUrl(path, 3600); // 1 hour
    ...
    async getHistoryData() {
        ...
        // 2. Fetch Logs
        const { data: logsData } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('habit_logs').select('*').eq('user_id', userId).gte('date', startDateStr);
        const logs = logsData || [];
        ...
        const { data: habitsData } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('habits').select('*').eq('user_id', userId);
        const habits = habitsData || [];
        const { data: cyclesData } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('cycles').select('*').eq('user_id', userId);
    ...
    async createVersion(data) {
        ...
        const { data: newVersion, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('versions').insert({
            user_id: userId,
            number: data.number,
            title: data.title,
            description: data.description,
            status: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EntityStatus"].ACTIVE,
    ...
    async updateGoal(updatedGoal) {
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('goals').update({
    ...
    async getMantras() {
        const userId = await this.getUserId();
        // 1. Get from Cycles
        const { data: cycles } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('cycles').select('mantras').eq('user_id', userId);
        const cycleMantras = new Set();
        cycles?.forEach((c)=>c.mantras?.forEach((m)=>cycleMantras.add(m)));
        // 2. Get from Archives (Mantra Bank)
        const { data: archives } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('archives').select('content').eq('user_id', userId).eq('type', __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ArchiveType"].MANTRA_BANK);
        archives?.forEach((a)=>{
    ...
    async createCycle(cycleData, goalsData, standaloneHabits) {
        ...
        const { count } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('cycles').select('*', {
            count: 'exact',
            head: true
        }).eq('version_id', profile.current_version_id);
        const sprintNum = (count || 0) + 1;
        // 2. Create Cycle
        const { data: newCycle, error: cycleError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('cycles').insert({
            user_id: userId,
        ...
        for (const gData of goalsData){
            ...
            const { data: goal, error: gError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('goals').insert({
                user_id: userId,
            ...
            if (gData.habit && goal) {
                // Create Linked Habit
                const { data: habit, error: hError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('habits').insert({
                    user_id: userId,
                    cycle_id: newCycle.id,
        ...
        for (const hData of standaloneHabits){
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('habits').insert({
                user_id: userId,
                cycle_id: newCycle.id,
                name: hData.name,
                weight: hData.weight,
    ...
    async getLabData() {
        ...
        const { data: versions } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('versions').select('*').eq('user_id', userId);
        const currentVersion = versions?.find((v)=>v.id === profile?.current_version_id) || null;
        // Fetch Cycles
        const { data: cycles } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('cycles').select('*').eq('user_id', userId).order('sprint_number', {
            ascending: false
        });
        ...
        const { data: goals } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('goals').select('*').eq('user_id', userId);
        const { data: habits } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('habits').select('*').eq('user_id', userId);
        return {
            goals: goals || [],
            version: currentVersion,
    ...
    async updateCycle(cycle) {
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('cycles').update({
    ...
    async deleteCycle(cycleId) {
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('cycles').delete().eq('id', cycleId);
        if (error) throw error;
    ...
    async addGoal(goal) {
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('goals').insert({
            id: goal.id,
            user_id: userId,
    ...
    async deleteGoal(goalId) {
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('goals').delete().eq('id', goalId);
        if (error) throw error;
    }
    // -- HABIT CRUD --
    async getAllHabits() {
        const userId = await this.getUserId();
        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('habits').select('*').eq('user_id', userId);
        return data || [];
    }
    async addHabit(habit) {
        const userId = await this.getUserId();
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('habits').insert({
            id: habit.id,
            user_id: userId,
    ...
    async updateHabit(habit) {
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('habits').update({
            name: habit.name,
            weight: habit.weight,
            category: habit.category,
            linked_goal_id: habit.linked_goal_id
    ...
    async deleteHabit(habitId) {
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('habits').delete().eq('id', habitId);
        if (error) throw error;
    }
    // -- DATABASE PAGE HELPERS --
    async getAllVersions() {
        const userId = await this.getUserId();
        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('versions').select('*').eq('user_id', userId).order('start_date', {
            ascending: false
        });
        return data || [];
    }
    async updateVersion(version) {
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('versions').update({
            title: version.title,
    ...
    async deleteVersion(versionId) {
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('versions').delete().eq('id', versionId);
        if (error) throw error;
    }
    async getAllCycles() {
        const userId = await this.getUserId();
        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('cycles').select('*').eq('user_id', userId).order('sprint_number', {
            ascending: false
        });
        return data || [];
    }
    async getAllGoals() {
        const userId = await this.getUserId();
        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('goals').select('*').eq('user_id', userId);
        return data || [];
    }
    async signOut() {
...
"[project]/src/components/TempoSettingsModal.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const TempoSettingsModal = ({ onClose })=>{
    _s();
    const [days, setDays] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(90);
    const [cycles, setCycles] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(6);
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TempoSettingsModal.useEffect": ()=>{
            const fetchSettings = {
                "TempoSettingsModal.useEffect.fetchSettings": async ()=>{
                    try {
            ...
            }["TempoSettingsModal.useEffect.fetchSettings"];
            fetchSettings();
        }
    }["TempoSettingsModal.useEffect"], []);
    const handleSave = async ()=>{
        setLoading(true);
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabaseService"].updateSystemSettings(days, cycles);
        setLoading(false);
        onClose();
    };
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                !isCleanDivison && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(TempoSettingsModal, "MQZbIKgy9wMG/GvkqRhyQUOgjbw=");
_c = TempoSettingsModal;
var _c;
__turbopack_context__.k.register(_c, "TempoSettingsModal");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/components/AccountSettingsModal.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const AccountSettingsModal = ({ onClose })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AccountSettingsModal.useEffect": ()=>{
            const fetchUserData = {
                "AccountSettingsModal.useEffect.fetchUserData": async ()=>{
                    const { data: { session } } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getSession();
                    if (session?.user) {
                        setUserData({
                        ...
                        const p = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabaseService"].getProfile();
                        setProfile(p);
                    }
                }
            }["AccountSettingsModal.useEffect.fetchUserData"];
            fetchUserData();
        }
    }["AccountSettingsModal.useEffect"], []);
    ...
    const handleFileChange = async (e)=>{
        ...
        try {
            setUploading(true);
            const publicUrl = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabaseService"].uploadAvatar(file);
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabaseService"].updateProfile({
...
_s(AccountSettingsModal, "zJssxQVOzb/eawyaW1sJQc2hxmY=");
_c = AccountSettingsModal;
var _c;
__turbopack_context__.k.register(_c, "AccountSettingsModal");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$TempoSettingsModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/TempoSettingsModal.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$AccountSettingsModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/AccountSettingsModal.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
const Layout = ({ children })=>{
    ...
    const [showTempoModal, setShowTempoModal] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: !isCollapsed ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            lineNumber: 88,
                            columnNumber: 13
                        }, ("TURBOPACK compile-time value", void 0)) : /* Collapsed Icon - Just the Portal */ /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            showTempoModal && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$TempoSettingsModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TempoSettingsModal"], {
            ...
            showAccountModal && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$AccountSettingsModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AccountSettingsModal"], {
...
_s(Layout, "bb51xd3GdNUulgWwzGLITYoS3uw=", false, function() {
    return [
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/supabase.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$PortalEntry$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/PortalEntry.tsx [app-client] (ecmascript)");
...
function PortalLayout({ children }) {
    ...
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PortalLayout.useEffect": ()=>{
            const checkSession = {
                "PortalLayout.useEffect.checkSession": async ()=>{
                    const { data: { session: activeSession } } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getSession();
                    setSession(activeSession);
                    setLoading(false);
                }
            }["PortalLayout.useEffect.checkSession"];
            checkSession();
            const { data: { subscription } } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.onAuthStateChange({
                "PortalLayout.useEffect": (_event, session)=>{
                    setSession(session);
                }
            }["PortalLayout.useEffect"]);
            return ({
                "PortalLayout.useEffect": ()=>subscription.unsubscribe()
            })["PortalLayout.useEffect"];
        }
    }["PortalLayout.useEffect"], []);
    if (loading) {
    ...
    if (!session) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$PortalEntry$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
            onEnter: ()=>{}
        }, void 0, false, {
            fileName: "[project]/src/app/(portal)/layout.tsx",
            lineNumber: 42,
...
_s(PortalLayout, "TxGGDQGkoqipomZRLDIyvaos53A=");
_c = PortalLayout;
var _c;
...
//# sourceMappingURL=src_35a5e247._.js.map