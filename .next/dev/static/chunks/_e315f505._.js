...
"[project]/src/app/(portal)/history/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const HistoryPage = ()=>{
    ...
    const [habitStats, setHabitStats] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    // Controls
    const [timeRange, setTimeRange] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('15d');
    const [selectedCycleId, setSelectedCycleId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HistoryPage.useEffect": ()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabaseService"].getHistoryData().then({
                "HistoryPage.useEffect": (res)=>{
                    setRawData(res.dailyScores);
                    setCycles(res.cycles);
                    setHabitStats(res.habitStats);
                    if (res.cycles.length > 0) setSelectedCycleId(res.cycles[0].id);
                    // Default select today
                    const today = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabaseService"].getLocalDateString();
    ...
    const displayData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HistoryPage.useMemo[displayData]": ()=>{
            if (!rawData) return [];
            const today = new Date();
            today.setHours(0, 0, 0, 0);
            if (timeRange === 'cycle' && selectedCycleId) {
                const cycle = cycles.find({
                    "HistoryPage.useMemo[displayData].cycle": (c)=>c.id === selectedCycleId
                }["HistoryPage.useMemo[displayData].cycle"]);
                if (cycle) {
                    ...
                    while(current <= end){
                        cycleDays.push(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabaseService"].getLocalDateString(current));
                        current.setDate(current.getDate() + 1);
                    }
                    return cycleDays.map({
                        "HistoryPage.useMemo[displayData]": (dateStr)=>{
                            const existing = rawData.find({
                                "HistoryPage.useMemo[displayData].existing": (d)=>d.date === dateStr
                            }["HistoryPage.useMemo[displayData].existing"]);
                            return existing || {
                                date: dateStr,
                                score: 0,
                                details: []
                ...
                const sortedRecords = [
                    ...
                    "HistoryPage.useMemo[displayData].sortedRecords": (a, b)=>new Date(b.date).getTime() - new Date(a.date).getTime()
                }["HistoryPage.useMemo[displayData].sortedRecords"]);
    ...
    const selectedDayDetails = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HistoryPage.useMemo[selectedDayDetails]": ()=>{
            if (!selectedDate) return null;
            return rawData.find({
                "HistoryPage.useMemo[selectedDayDetails]": (d)=>d.date === selectedDate
            }["HistoryPage.useMemo[selectedDayDetails]"]) || null;
        }
    }["HistoryPage.useMemo[selectedDayDetails]"], [
        selectedDate,
        rawData
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("header", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            timeRange === 'cycle' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "relative",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                        ...
                                        children: cycles.map((c)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                value: c.id,
                                                children: [
                                                    "Cycle ",
                                                    c.sprint_number
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: selectedDayDetails ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(HistoryPage, "//FxFDM2qu2OVzQzXVFbSN5BMiQ=");
_c1 = HistoryPage;
...
//# sourceMappingURL=_e315f505._.js.map